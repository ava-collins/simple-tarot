...
-   [Private Retrieval-Evaluation Harness Implementation Plan](./docs/superpowers/plans/2026-07-20-private-retrieval-evaluation-harness.md) — five manually gated checkpoints covering shared trace capture, the development route, private interactive records, documentation, and authorized deployment verification
